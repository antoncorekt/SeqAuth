package com.kozlovsky.security.dto;

import com.kozlovsky.user.model.Role;
...
public class ExampleUserDetailsTest {
    ...
    public void build_UserRegisteredByUsingFormRegistration_ShouldCreateNewObject() {
        ...
        ExampleUserDetailsAssert.assertThat(user).hasFirstName(FIRST_NAME)
                .hasId(ID)
    ...
    public void build_UserUsingSocialSignIn_ShouldCreateNewObject() {
        ...
        ExampleUserDetailsAssert.assertThat(user)
